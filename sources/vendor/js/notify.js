var Notify = function () {
    ...
    return function () {
        function o(o) {
            ...
            this.status = c, this.title = C, this.text = h, this.showIcon = l, this.customIcon = u, this.customClass = v, this.speed = y, this.effect = L, this.showCloseButton = I, this.autoclose = E, this.autotimeout = O, this.gap = b, this.distance = T, this.type = a, this.position = _, this.checkRequirements() ? (this.setContainer(), this.setWrapper(), this.setPosition(), this.showIcon && this.setIcon(), this.showCloseButton && this.setCloseButton(), this.setContent(), this.container.append(this.wrapper), this.setEffect(), this.notifyIn(this.selectedNotifyInEffect), this.autoclose && this.autoClose(), this.setObserver()) : console.error("You must specify 'title' or 'text' at least.")
        }
        return o.prototype.checkRequirements = function () {
            ...
            e.classList.add("notify__close"), e.innerHTML = '<i class="fa fa-times-circle fa-lg" aria-hidden="true"></i>', this.wrapper.appendChild(e), e.addEventListener("click", (function () {
                t.close()
            }))
